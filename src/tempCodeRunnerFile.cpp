...
float joint1, joint1_awal = 0, joint1_cmd;
float joint2, joint2_awal = 20, joint2_cmd;
float joint3, joint3_awal = 45, joint3_cmd;
float joint4, joint4_awal = 0, joint4_cmd;
float joint5, joint5_awal = 60, joint5_cmd;
float joint6, joint6_awal = 0, joint6_cmd;
